...
LangString alreadyInstalledLong ${LANG_SIMPCHINESE} "${PRODUCTNAME} ${VERSION} 已经安装在你的系统中。请选择你要执行的操作，然后点击「下一步」继续。"
...
LangString choowHowToInstall ${LANG_SIMPCHINESE} "请选择你希望如何安装 ${PRODUCTNAME}。"
...
LangString failedToKillApp ${LANG_SIMPCHINESE} "无法关闭 {{product_name}}。请先手动关闭它，然后重试。"
LangString installingWebview2 ${LANG_SIMPCHINESE} "正在安装 WebView2..."
LangString newerVersionInstalled ${LANG_SIMPCHINESE} "${PRODUCTNAME} 的更新版本已经安装！不建议安装旧版本。如果你确实想安装这个旧版本，最好先卸载当前版本。请选择你要执行的操作，然后点击「下一步」继续。"
LangString older ${LANG_SIMPCHINESE} "较旧"
LangString olderOrUnknownVersionInstalled ${LANG_SIMPCHINESE} "你的系统中安装了一个 $R4 版本的 ${PRODUCTNAME}。建议在安装前先卸载当前版本。请选择你要执行的操作，然后点击「下一步」继续。"
LangString silentDowngrades ${LANG_SIMPCHINESE} "此安装程序禁用了降级安装，无法以静默方式继续安装。请改用图形界面安装程序。$\n"
...
LangString webview2AbortError ${LANG_SIMPCHINESE} "WebView2 安装失败！程序无法在没有 WebView2 的情况下运行。请重新启动安装程序。"
